...
def upload():
    if request.method == 'POST':
        ...
        model = pickle.loads(open(r"C:\Users\JahnaviP\Desktop\flask\Detecting_Parkinson_Disease_Using_ML-main\Detecting_Parkinson_Disease_Using_ML-main\Training\parkinson_wave.pkl", "rb").read())
