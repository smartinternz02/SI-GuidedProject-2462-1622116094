...
def upload():
    if request.method == 'POST':
        ...
        model = pickle.loads(open(r"C:\Users\DELL\Desktop\flask\Detecting_Parkinson_Disease_Using_ML-main\Detecting_Parkinson_Disease_Using_ML-main\Flask_App\Training\parkinson1.pkl", "rb").read())
